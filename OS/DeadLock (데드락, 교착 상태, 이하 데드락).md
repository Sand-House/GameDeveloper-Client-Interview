...
데드락은 공유 자원에 대해서 타 프로세스가 선점한 자원을 필요로 하고 그 선점한 프로세스도 타 프로세스의 선점 자원을 원해 서로 무한정 기다리게 되는 것입니다.
...
- 상호 배제 : 공유 자원에 대한 상호 배제를 하고 있을 때
- 점유 대기 : 추가적인 자원을 위해 기다리고 있을 때
- 비선점 : 선취 불가능(No Preemptive)
  - 다른 프로세스 종료가 안되는 경우
- 순환 대기 : 자원 관계에 있어서 사이클이 있을 때 
